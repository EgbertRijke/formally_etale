...
\item Modality is defined in \cite{UFP}{Section 7.7}.
...
\item The application \ref{sec:topological stacks} suggests a new notion of covering space for topological stacks and shows that
  one interpretation of \ref{thm:modal descent} is an extension of the classcial fundamental theorem of the theory of covering spaces,
...
We will provide details and definitions of the relevant categories for the other examples below.
...
In \cite{wellen-thesis}{Section 4.4} there is a calculation showing that the formally étale maps in the sense of \cite{GrothendieckDieudonne}{§ 17} are included in the $\Im$-étale maps, if we transfer this notion in the empty context to the topos.
