...
The following is a descent theorem for formally étale maps.
...
\begin{cor}
Suppose $P:X\to\UU_\modal$ is a family of modal types such that the projection map $\proj 1:\big(\sm{x:X}P(x)\big)\to X$ is formally \'etale. Then $P$ has a unique extension
\begin{equation*}
\begin{tikzcd}
