...
Felix Wellen introduced the notion of $\modal$-\'etale maps for an arbitrary modality $\modal$.
...
The class of $\modal$-\'etale maps is precisely the class of maps that arise as pullbacks of maps between modal types.
\end{cor}
...
\section{$\modal$-\'etale maps for the $n$-truncations}

The $n$-equivalences are easily described: they are just the maps that induce isomorphisms on the first $n$ homotopy groups. In this section our goal is to characterize the $\modal$-\'etale maps for the $n$-truncations. We call such maps \define{$n$-\'etale}. Note that the case of propositional truncation has already been addressed in \cref{eg:etale_prop}.
